...
function buildItemPage(): ParsedItemPage {
  return {
    item: {
      ...
      storyTitle: null,
      storyLink: null,
      voteState: { kind: 'available', upHref: 'vote?id=story-1&how=up', downHref: null },
      hideAction: { kind: 'unavailable' },
      pastUrl: null,
      favoriteAction: { kind: 'unavailable' },
      flagAction: { kind: 'available', href: 'flag?id=story-1' },
      isDead: false,
      isFlagged: false,
      isDeleted: false,
    },
    ...
    comments: [
      {
        ...
        isFlagged: false,
        collapsedCount: 0,
        voteState: { kind: 'available', upHref: 'vote?id=comment-1&how=up', downHref: null },
        flagAction: { kind: 'available', href: 'flag?id=comment-1' },
        editUrl: null,
        deleteUrl: null,
        ...
        children: [
          {
            ...
            voteState: {
              kind: 'active',
              direction: 'up',
              unvoteHref: 'vote?id=comment-2&how=un',
              upHref: 'vote?id=comment-2&how=up',
              downHref: 'vote?id=comment-2&how=down',
            },
            flagAction: { kind: 'active', href: 'flag?id=comment-2&un=t' },
            editUrl: null,
            deleteUrl: null,
